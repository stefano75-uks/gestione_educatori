...
// Esegui la query per recuperare tutti gli utenti con limitazione e offset
$sql = "SELECT id, nome, cognome, telefono, reparto, matricola, foto FROM users LIMIT $perPage OFFSET $offset";
    ...
    <div class="container-fluid">
            ...
            <tbody>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        /*echo "<td>";
                        if (!empty($row['foto'])) {
                            echo "<img src='foto_utenti/" . htmlspecialchars($row['foto']) . "' alt='Foto di " . htmlspecialchars($row['nome']) . "' width='50' height='50'>";
                        }*/
                        echo "</td>";
        ...
        <nav aria-label="Page navigation">  
             <ul class="pagination">
                <?php if ($page > 1) : ?>
                    <li class="page-item">
                        <a class="page-link" href="?page=<?php echo $page - 1; ?>&perPage=<?php echo $perPage; ?>">Precedente</a>
                    </li>
                <?php endif; ?>
                <li class="page-item <?php if ($page == 1) echo 'active'; ?>">
                    <a class="page-link" href="?page=1&perPage=<?php echo $perPage; ?>">1</a>
                </li>
                <?php if ($totalPages > 1) : ?>
                    <li class="page-item disabled"><span class="page-link">...</span></li>
                    <li class="page-item <?php if ($page == $totalPages) echo 'active'; ?>">
                        <a class="page-link" href="?page=<?php echo $totalPages; ?>&perPage=<?php echo $perPage; ?>"><?php echo $totalPages; ?></a>
                    </li>
                <?php endif; ?>
                <?php if ($page < $totalPages) : ?>
                    <li class="page-item">
                        <a class="page-link" href="?page=<?php echo $page + 1; ?>&perPage=<?php echo $perPage; ?>">Successivo</a>
                    </li>
                <?php endif; ?>
